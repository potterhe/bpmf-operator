...
//+kubebuilder:rbac:groups=webapp.bpmf.io,resources=visitorsapps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=webapp.bpmf.io,resources=visitorsapps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=webapp.bpmf.io,resources=visitorsapps/finalizers,verbs=update
